...
using WebAPIDemos.Server.Models;

namespace WebAPIDemos.Server.Controllers
{
    ...
    public class MyObjectsController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get(int id)
        {
            ...
            var result = new ApiServiceResponse<MyObject>(await _myObjectService.GetMyObject(id.AsServiceRequest()));
        ...
        public async Task<HttpResponseMessage> Post(MyObject newObject)
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.BadRequest, new ApiServiceResponse<int>());
            }

            var result = new ApiServiceResponse<int>(await _myObjectService.InsertMyObject(newObject.AsServiceRequest()));
